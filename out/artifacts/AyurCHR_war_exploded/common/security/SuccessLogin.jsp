...
<form method="post" action="Sample.jsp">
    ...
    <table width="500px" align="center"
        ...
        <tr>
            ...
            <td width="300px"><input size="50" type="text" name="dummytoken" value="asdadadadadadad"
    ...
    <% session.setAttribute("token", "asdadadadadadad"); %>
    <input type="hidden" name="token" value="<%=session.getAttribute("token").toString()%>"></input>
</form>
</body>
</html>